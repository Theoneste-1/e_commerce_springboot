...
import theo.dev.ecommerce.dto.category_brand.BrandCreateRequest;
import theo.dev.ecommerce.dto.category_brand.BrandResponse;
import theo.dev.ecommerce.dto.category_brand.BrandUpdateRequest;
import theo.dev.ecommerce.exceptions.DuplicateResourceException;
import theo.dev.ecommerce.services.product.BrandService;
...
public class BrandController {
    ...
    @PostMapping
    public ResponseEntity<BrandResponse> createBrand(@RequestBody @Valid BrandCreateRequest request)
