package theo.dev.ecommerce.controllers.wishlist;

import theo.dev.ecommerce.dto.wishlist.WishlistCreateRequest;
import theo.dev.ecommerce.dto.wishlist.WishlistItemCreateRequest;
import theo.dev.ecommerce.dto.wishlist.WishlistResponse;
import theo.dev.ecommerce.dto.wishlist.WishlistUpdateRequest;
import theo.dev.ecommerce.services.wishlist.WishlistService;
...
public class WishlistController {
    ...
    public ResponseEntity<WishlistResponse> addWishlistItem(@PathVariable String id,
    ...
    @PutMapping("/{id}")
    public ResponseEntity<WishlistResponse> updateWishlist(@PathVariable String id,
