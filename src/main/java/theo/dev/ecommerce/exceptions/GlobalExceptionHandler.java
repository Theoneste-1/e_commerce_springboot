...
import theo.dev.ecommerce.dto.auth.Role;
import theo.dev.ecommerce.dto.exceptions.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleAccessDeniedException(
        ...
        apiError.setMessage(
                "You do not have permission to access this resource. Please provide a valid token or contact admin.");
    ...
    public ResponseEntity<String> handleDuplicate(DuplicateResourceException ex) {
        logger.error("duplication error: {}", ex.getMessage());
